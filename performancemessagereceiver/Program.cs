...
namespace performancemessagereceiver
{
    class Program
    {
        ...
        const string SubscriptionName = "America";
        ...
        {
           Console.WriteLine($"Mensaje recibido: SequenceNumber:{message.SystemProperties.SequenceNumber} Body:{Encoding.UTF8.GetString(message.Body)}");
